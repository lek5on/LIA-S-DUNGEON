...
## Quick Demo (single-player)

This repository now includes a small demo that exercises the new
player/item/mob code. To run it locally:

```bash
lein run -m mire.core
```

It will initialize a player, equip a sword, spawn a zombie and show
